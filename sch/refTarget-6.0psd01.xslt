...
<xsl:stylesheet xmlns:appinfo="https://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Rules for reference schema documents"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-82a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-82b</xsl:attribute>
            <xsl:attribute name="name">No disallowed substitutions</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-82c</xsl:attribute>
            <xsl:attribute name="name">No disallowed substitutions</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-83a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-83b</xsl:attribute>
            <xsl:attribute name="name">No disallowed derivation</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-83c</xsl:attribute>
            <xsl:attribute name="name">No disallowed derivation</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-84</xsl:attribute>
            <xsl:attribute name="name">Element declaration is nillable</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">External attribute use only in adapter type</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Rules for reference schema documents</svrl:text>
   ...
   <!--PATTERN rule8-9Subset namespace asserts conformance-->
   ...
   <xsl:template match="*[. is nf:get-document-element(.)]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:any" priority="1001" mode="M155">
   ...
   <!--RULE -->
   <xsl:template match="xs:anyAttribute" priority="1000" mode="M155">
   ...
   <xsl:template match="xs:import[                           nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))                           and exists(@namespace)                           and empty(@appinfo:externalImportIndicator)                           and not(xs:anyURI(@namespace) = (xs:anyURI('https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/'),                                                            xs:anyURI('http://www.w3.org/XML/1998/namespace')))]"
                 ...
                 mode="M156">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:import[                           nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))                           and exists(@namespace)                           and empty(@appinfo:externalImportIndicator)                           and not(xs:anyURI(@namespace) = (xs:anyURI('https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/'),                                                            xs:anyURI('http://www.w3.org/XML/1998/namespace')))]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="some $schema in nf:resolve-namespace(., @namespace) satisfies nf:has-effective-conformance-target-identifier($schema, xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN rule9-87Element declaration is nillable-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-87: An element declaration in an extension schema document MUST have the {nillable} property with a value of true.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M157"/>
   ...
   <!--PATTERN rule9-80No simple type disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No simple type disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:simpleType" priority="1000" mode="M158">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:simpleType"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@final)">
               ...
               <svrl:text>Rule 9-80: A reference schema document MUST NOT have an attribute {}final.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M158"/>
   ...
   <!--PATTERN rule9-82aNo disallowed substitutions-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed substitutions</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M159">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@block)">
               ...
               <svrl:text>Rule 9-82: A reference schema document MUST NOT contain the attribute {}block or {}blockDefault.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M159"/>
   ...
   <!--PATTERN rule9-82bNo disallowed substitutions-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed substitutions</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element" priority="1000" mode="M160">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@block)"/>
   ...
   <!--PATTERN rule9-82cNo disallowed substitutions-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed substitutions</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M161">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN rule9-83aNo disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M162">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@final)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@final)">
               ...
               <svrl:text>Rule 9-83: A reference schema document MUST NOT contain the attribute {}final or {}finalDefault.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M162"/>
   ...
   <!--PATTERN rule9-83bNo disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element" priority="1000" mode="M163">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@final)"/>
   ...
   <!--PATTERN rule9-83cNo disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M164">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN rule9-84Element declaration is nillable-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Element declaration is nillable</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[@name and (empty(@abstract)                                             or xs:boolean(@abstract) = false())]"
                 priority="1000"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-84: An element declaration in a reference schema document MUST have the {nillable} property with a value of true.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M165"/>
   ...
   <!--PATTERN rule9-85No `xs:choice`-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No `xs:choice`</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:choice" priority="1000" mode="M166">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:choice"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="false()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               ...
               <svrl:text>Rule 9-85: A reference schema document MUST NOT contain the element xs:choice.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M166"/>
   ...
   <!--PATTERN rule9-86External attribute use only in adapter type-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">External attribute use only in adapter type</svrl:text>
   <!--RULE -->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-86: An external attribute use within a reference schema document MUST be in an adapter type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M167"/>
