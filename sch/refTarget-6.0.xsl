<?xml version="1.0"?>
<xsl:stylesheet xmlns:appinfo="https://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/" xmlns:catalog="urn:oasis:names:tc:entity:xmlns:xml:catalog" xmlns:ct="https://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/6.0/" xmlns:impl="http://example.org/impl" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:nf="https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#NDRFunctions" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:structures="https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:ns-prefix-in-attribute-values uri="https://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/" prefix="appinfo"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:tc:entity:xmlns:xml:catalog" prefix="catalog"/>
         <svrl:ns-prefix-in-attribute-values uri="https://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/6.0/" prefix="ct"/>
         <svrl:ns-prefix-in-attribute-values uri="http://example.org/impl" prefix="impl"/>
         <svrl:ns-prefix-in-attribute-values uri="https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#NDRFunctions" prefix="nf"/>
         <svrl:ns-prefix-in-attribute-values uri="http://saxon.sf.net/" prefix="saxon"/>
         <svrl:ns-prefix-in-attribute-values uri="https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/" prefix="structures"/>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-29a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-29b</xsl:attribute>
            <xsl:attribute name="name">Type definition is top-level</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-33</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-34</xsl:attribute>
            <xsl:attribute name="name">Object type derived from structures:ObjectType</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-37a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-37b</xsl:attribute>
            <xsl:attribute name="name">Component reference defined by conformant schema</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-38</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-40</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-42a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-42b</xsl:attribute>
            <xsl:attribute name="name">Declarations are top-level</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-43a</xsl:attribute>
            <xsl:attribute name="name">Element type is not simple type</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-43b</xsl:attribute>
            <xsl:attribute name="name">Element type is not simple type</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-44a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-44b</xsl:attribute>
            <xsl:attribute name="name">Attribute and element type is from conformant namespace</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-45</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-47</xsl:attribute>
            <xsl:attribute name="name">Only reference attributes have type xs:IDREFS</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-49</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">Structure of adapter type definition follows pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-51</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-52a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-52b</xsl:attribute>
            <xsl:attribute name="name">External adapter type not a base type</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-53</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-58b</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-62</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-70a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-70b</xsl:attribute>
            <xsl:attribute name="name">Augmentation point element use is optional and unbounded</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-80</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-82</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-83</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-85</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule8-9</xsl:attribute>
            <xsl:attribute name="name">Reference namespace asserts conformance</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule8-10</xsl:attribute>
            <xsl:attribute name="name">Reference namespace does not have wildcard</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule8-12</xsl:attribute>
            <xsl:attribute name="name">Reference namespace uses reference namespace components</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-86</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-87</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-88a</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-88b</xsl:attribute>
            <xsl:attribute name="name">No disallowed substitutions</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-88c</xsl:attribute>
            <xsl:attribute name="name">No disallowed substitutions</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-89a</xsl:attribute>
            <xsl:attribute name="name">No disallowed derivation</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-89b</xsl:attribute>
            <xsl:attribute name="name">No disallowed derivation</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-89c</xsl:attribute>
            <xsl:attribute name="name">No disallowed derivation</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-90</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule9-91</xsl:attribute>
  ...
  <!-- end NDR-FUNCTIONS -->
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[some $name in @name,                                      $extension in xs:simpleContent/xs:extension,                                      $base-qname in resolve-QName($extension/@base, $extension) satisfies                                      $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]" priority="1001" mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[some $name in @name,                                      $extension in xs:simpleContent/xs:extension,                                      $base-qname in resolve-QName($extension/@base, $extension) satisfies                                      $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]"/>
      <!--REPORT warning-->
      <xsl:if test="false()">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[(self::xs:simpleType or self::xs:complexType) and exists(@name)]" priority="1000" mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[(self::xs:simpleType or self::xs:complexType) and exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Name of Class, Datatype, and Property components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name) and ends-with(@name, 'SimpleType')]" priority="1001" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name) and ends-with(@name, 'SimpleType')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="local-name() = 'simpleType'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="local-name() = 'simpleType'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 7-2: Class and Datatype components MUST have a name ending in "Type"; Property components MUST NOT</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name) and ends-with(@name, 'Type')]" priority="1000" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name) and ends-with(@name, 'Type')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="local-name() = 'complexType'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="local-name() = 'complexType'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 7-2: Class and Datatype components MUST have a name ending in "Type"; Property components MUST NOT</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <xsl:variable name="is-adapter-type" select="exists(@name[ends-with(., 'AdapterType')])"/>
      <xsl:variable name="has-adapter-base-type" select="         exists(xs:complexContent[         exists(xs:*[local-name() = ('extension', 'restriction')         and exists(@base[ends-with(., 'AdapterType')])])])"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="$is-adapter-type = $has-adapter-base-type"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$is-adapter-type = $has-adapter-base-type">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M14">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <xsl:variable name="is-association-type" select="exists(@name[ends-with(., 'AssociationType')])"/>
      <xsl:variable name="has-association-base-type" select="         exists(xs:complexContent[         exists(xs:*[local-name() = ('extension', 'restriction')         and exists(@base[ends-with(., 'AssociationType')])])])"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="$is-association-type = $has-association-base-type"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$is-association-type = $has-association-base-type">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:simpleType[exists(@name)        and (xs:restriction/xs:enumeration             or xs:restriction[ends-with(local-name-from-QName(resolve-QName(@base, .)), 'CodeSimpleType')])]" priority="1000" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:simpleType[exists(@name)        and (xs:restriction/xs:enumeration             or xs:restriction[ends-with(local-name-from-QName(resolve-QName(@base, .)), 'CodeSimpleType')])]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ends-with(@name, 'CodeSimpleType')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ends-with(@name, 'CodeSimpleType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[exists(xs:simpleContent[                         exists(xs:*[local-name() = ('extension', 'restriction')                                     and (ends-with(@base, 'CodeSimpleType')                                     or ends-with(@base, 'CodeType'))])])]" priority="1000" mode="M16">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[exists(xs:simpleContent[                         exists(xs:*[local-name() = ('extension', 'restriction')                                     and (ends-with(@base, 'CodeSimpleType')                                     or ends-with(@base, 'CodeType'))])])]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ends-with(@name, 'CodeType')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ends-with(@name, 'CodeType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@name]" priority="1000" mode="M17">
      ...
      <xsl:if test="not(exists(@abstract[xs:boolean(.) = true()])                    eq (ends-with(@name, 'Abstract')                        or ends-with(@name, 'AugmentationPoint')                        or ends-with(@name, 'Representation')))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(@abstract[xs:boolean(.) = true()]) eq (ends-with(@name, 'Abstract') or ends-with(@name, 'AugmentationPoint') or ends-with(@name, 'Representation')))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M18">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(@type[ends-with(., 'AssociationType')])                        = exists(@name[ends-with(., 'Association')])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(@type[ends-with(., 'AssociationType')]) = exists(@name[ends-with(., 'Association')])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name) and exists(@type) and ends-with(@type, 'CodeType')]" priority="1000" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@name) and exists(@type) and ends-with(@type, 'CodeType')]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Name of code properties</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name) and exists(@type) and ends-with(@type, 'CodeSimpleType')]" priority="1000" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[exists(@name) and exists(@type) and ends-with(@type, 'CodeSimpleType')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ends-with(@name, 'Code')"/>
         <xsl:otherwise>
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M21">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="matches(@name, '^[A-Za-z0-9\-_\.]*$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(@name, '^[A-Za-z0-9\-_\.]*$')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M22">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute" priority="1002" mode="M23">
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[some $name in @name,                                      $extension in xs:simpleContent/xs:extension,                                      $base-qname in resolve-QName($extension/@base, $extension) satisfies                                      $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]" priority="1001" mode="M23">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[some $name in @name,                                      $extension in xs:simpleContent/xs:extension,                                      $base-qname in resolve-QName($extension/@base, $extension) satisfies                                      $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]"/>
      <!--REPORT warning-->
      <xsl:if test="false()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M23">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="matches(@name, '^[A-Z]')"/>
   ...
   <!--RULE -->
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M24">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(@literal) or exists(@definition)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M25">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $definition in (xs:annotation/xs:documentation)[1] satisfies string-length(normalize-space(string($definition))) &gt; 0">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Model component has data definition</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $definition in xs:annotation/xs:documentation[1] satisfies                          string-length(normalize-space(string($definition))) &gt; 0"/>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Model component has data definition</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M28">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $definition in xs:annotation/xs:documentation[1] satisfies                          string-length(normalize-space(string($definition))) &gt; 0"/>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Model component has data definition</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $definition in xs:annotation/xs:documentation[1] satisfies                          string-length(normalize-space(string($definition))) &gt; 0"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:enumeration" priority="1000" mode="M30">
   ...
   <!--RULE -->
   <xsl:template match="xs:element[xs:boolean(@abstract) = true()                         and not(ends-with(@name, 'AugmentationPoint'))]/xs:annotation/xs:documentation[1]" priority="1000" mode="M31">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[xs:boolean(@abstract) = true()                         and not(ends-with(@name, 'AugmentationPoint'))]/xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(starts-with(lower-case(normalize-space(.)), 'a data concept'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(starts-with(lower-case(normalize-space(.)), 'a data concept'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[ends-with(@name, 'Association')                                  and not(xs:boolean(@abstract) eq true())]/xs:annotation/xs:documentation[1]" priority="1000" mode="M32">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[ends-with(@name, 'Association')                                  and not(xs:boolean(@abstract) eq true())]/xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (relationship|association)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (relationship|association)'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Date') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]" priority="1000" mode="M33">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Date') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (date|month|year)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (date|month|year)'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Quantity') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]" priority="1000" mode="M34">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Quantity') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (count|number)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (count|number)'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Picture') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]" priority="1000" mode="M35">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Picture') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (image|picture|photograph)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (image|picture|photograph)'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Indicator') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]" priority="1000" mode="M36">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Indicator') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^true if .*; false (otherwise|if)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^true if .*; false (otherwise|if)'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Identification') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]" priority="1000" mode="M37">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Identification') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? identification'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? identification'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Name') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]" priority="1000" mode="M38">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[(self::xs:element or self::xs:attribute)                         and ends-with(@name, 'Name') and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^(a|an)( .*)? name'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^(a|an)( .*)? name'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                         and @name                         and not(ends-with(@name, 'Indicator'))                         and not(ends-with(@name, 'Augmentation'))                         and not(ends-with(@name, 'Metadata'))                         and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]" priority="1000" mode="M39">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[(self::xs:element or self::xs:attribute)                         and @name                         and not(ends-with(@name, 'Indicator'))                         and not(ends-with(@name, 'Augmentation'))                         and not(ends-with(@name, 'Metadata'))                         and not(xs:boolean(@abstract) eq true())]                        /xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an? '))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^an? '))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[ends-with(@name, 'AssociationType')]/xs:annotation/xs:documentation[1]" priority="1000" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[ends-with(@name, 'AssociationType')]/xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^a data type for (a relationship|an association)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^a data type for (a relationship|an association)'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $version in @version satisfies                        string-length(normalize-space(@version)) &gt; 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $version in @version satisfies string-length(normalize-space(@version)) &gt; 0">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[exists(@ct:*[local-name() != 'conformanceTargets'])]" priority="1000" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[exists(@ct:*[local-name() != 'conformanceTargets'])]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="false()"/>
         <xsl:otherwise>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schema is CTAS-conformant</svrl:text>
   <!--RULE -->
   <xsl:template match="ct:*" priority="1000" mode="M43">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schema is CTAS-conformant</svrl:text>
   <!--RULE -->
   <xsl:template match="*[exists(@xsi:type['http://release.niem.gov/niem/conformanceTargets/3.0/' = namespace-uri-from-QName(resolve-QName(., ..))])]" priority="1000" mode="M44">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[exists(@xsi:type['http://release.niem.gov/niem/conformanceTargets/3.0/' = namespace-uri-from-QName(resolve-QName(., ..))])]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="false()"/>
         <xsl:otherwise>
   ...
   <!--RULE -->
   <xsl:template match="*[. is nf:get-document-element(.)                         or exists(@ct:conformanceTargets)]" priority="1000" mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[. is nf:get-document-element(.)                         or exists(@ct:conformanceTargets)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="(. is nf:get-document-element(.)) = exists(@ct:conformanceTargets)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(. is nf:get-document-element(.)) = exists(@ct:conformanceTargets)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="*[. is nf:get-document-element(.)]" priority="1000" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[. is nf:get-document-element(.)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:notation" priority="1000" mode="M47">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:all" priority="1000" mode="M48">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:unique" priority="1000" mode="M49">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:key" priority="1000" mode="M50">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:keyref" priority="1000" mode="M51">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:group" priority="1000" mode="M52">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attributeGroup[@name]" priority="1000" mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attributeGroup[@name]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="false()"/>
         <xsl:otherwise>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:redefine[@name]" priority="1000" mode="M54">
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited schema components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:include[@name]" priority="1000" mode="M55">
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M56">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="namespace-uri-from-QName(resolve-QName(@base, .)) != xs:anyURI('http://www.w3.org/XML/1998/namespace')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M57">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:ID')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M58">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:IDREF')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M59">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:IDREFS')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M60">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:anyType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M61">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:anySimpleType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M62">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:NOTATION')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M63">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:ENTITY')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited base types</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M64">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@base)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="resolve-QName(@base, .) != xs:QName('xs:ENTITIES')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@base, .) != xs:QName('xs:ENTITIES')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@itemType)]" priority="1000" mode="M65">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@itemType)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="resolve-QName(@itemType, .) != xs:QName('xs:ID')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@itemType, .) != xs:QName('xs:ID')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@itemType)]" priority="1000" mode="M66">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@itemType, .) != xs:QName('xs:IDREF')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@itemType)]" priority="1000" mode="M67">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@itemType, .) != xs:QName('xs:anySimpleType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited list item types</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[exists(@itemType)]" priority="1000" mode="M68">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@itemType)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="resolve-QName(@itemType, .) != xs:QName('xs:ENTITY')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@itemType, .) != xs:QName('xs:ENTITY')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@memberTypes)]" priority="1000" mode="M69">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@memberTypes)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="every $type-qname                        in tokenize(normalize-space(@memberTypes), ' ')                        satisfies resolve-QName($type-qname, .) != xs:QName('xs:ID')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in tokenize(normalize-space(@memberTypes), ' ') satisfies resolve-QName($type-qname, .) != xs:QName('xs:ID')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@memberTypes)]" priority="1000" mode="M70">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in tokenize(normalize-space(@memberTypes), ' ') satisfies resolve-QName($type-qname, .) != xs:QName('xs:IDREF')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@memberTypes)]" priority="1000" mode="M71">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in tokenize(normalize-space(@memberTypes), ' ') satisfies resolve-QName($type-qname, .) != xs:QName('xs:IDREFS')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@memberTypes)]" priority="1000" mode="M72">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in tokenize(normalize-space(@memberTypes), ' ') satisfies resolve-QName($type-qname, .) != xs:QName('xs:anySimpleType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:*[exists(@memberTypes)]" priority="1000" mode="M73">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in tokenize(normalize-space(@memberTypes), ' ') satisfies resolve-QName($type-qname, .) != xs:QName('xs:ENTITY')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited union item types</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[exists(@memberTypes)]" priority="1000" mode="M74">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@memberTypes)]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in tokenize(normalize-space(@memberTypes), ' ') satisfies resolve-QName($type-qname, .) != xs:QName('xs:ENTITIES')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M75">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="resolve-QName(@type, .) != xs:QName('xs:ID')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@type, .) != xs:QName('xs:ID')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M76">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@type, .) != xs:QName('xs:IDREF')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M77">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@type, .) != xs:QName('xs:ENTITY')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M78">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@type, .) != xs:QName('xs:ENTITIES')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Prohibited attribute types</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M79">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="resolve-QName(@type, .) != xs:QName('xs:anySimpleType')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="resolve-QName(@type, .) != xs:QName('xs:anySimpleType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[exists(@mixed)]" priority="1000" mode="M80">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[exists(@mixed)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="xs:boolean(@mixed) = false()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:boolean(@mixed) = false()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No mixed content on complex type or complex content</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexContent[exists(@mixed)]" priority="1000" mode="M81">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexContent[exists(@mixed)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="xs:boolean(@mixed) = false()"/>
         <xsl:otherwise>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M82">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(xs:simpleContent) or exists(xs:complexContent)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(xs:simpleContent) or exists(xs:complexContent)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType/xs:complexContent/xs:*[                         (self::xs:extension or self::xs:restriction)                         and (some $base-qname in resolve-QName(@base, .) satisfies                                namespace-uri-from-QName($base-qname) = nf:get-target-namespace(.))]" priority="1000" mode="M83">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType/xs:complexContent/xs:*[                         (self::xs:extension or self::xs:restriction)                         and (some $base-qname in resolve-QName(@base, .) satisfies                                namespace-uri-from-QName($base-qname) = nf:get-target-namespace(.))]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $base-type in nf:resolve-type(., resolve-QName(@base, .)) satisfies empty($base-type/self::xs:complexType/xs:simpleContent)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:complexType[          nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))          or nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ExtensionSchemaDocument'))        ]/xs:complexContent" priority="1000" mode="M84">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $derivation in xs:*[self::xs:extension or self::xs:restriction], $base-qname in resolve-QName($derivation/@base, $derivation), $base-type in nf:resolve-type($derivation, $base-qname) satisfies empty($base-type/self::xs:complexType/xs:simpleContent)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-12: The base type of a complex type with complex content MUST have complex content.</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="xs:schema/xs:element[empty(@type)]" priority="1000" mode="M85">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema/xs:element[empty(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(@abstract)                        and xs:boolean(@abstract) = true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(@abstract) and xs:boolean(@abstract) = true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Untyped element is abstract</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)                                  and resolve-QName(@type, .) = xs:QName('xs:anySimpleType')]" priority="1000" mode="M86">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@type)                                  and resolve-QName(@type, .) = xs:QName('xs:anySimpleType')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(@abstract)                        and xs:boolean(@abstract) = true()"/>
         <xsl:otherwise>
   ...
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M87">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="for $type-qname in resolve-QName(@type, .) return $type-qname = xs:QName('xs:anySimpleType') or namespace-uri-from-QName($type-qname) != xs:anyURI('http://www.w3.org/2001/XMLSchema')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Element type not in the XML or XML Schema namespace</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M88">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="namespace-uri-from-QName(resolve-QName(@type, .)) != 'http://www.w3.org/XML/1998/namespace'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="namespace-uri-from-QName(resolve-QName(@type, .)) != 'http://www.w3.org/XML/1998/namespace'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-14: An element type MUST NOT be in the XML Schema namespace or the XML namespace.</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@type]" priority="1000" mode="M89">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in resolve-QName(@type, .), $type-ns in namespace-uri-from-QName($type-qname), $type-local-name in local-name-from-QName($type-qname) satisfies ( $type-qname = xs:QName('xs:anySimpleType') or (($type-ns = nf:get-target-namespace(.) or exists(nf:get-document-element(.)/xs:import[ xs:anyURI(@namespace) = $type-ns and empty(@appinfo:externalImportIndicator)])) and not(ends-with($type-local-name, 'SimpleType'))))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M90">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No default or fixed value</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element" priority="1000" mode="M92">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No default or fixed value</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute" priority="1000" mode="M94">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@fixed)"/>
   ...
   <xsl:template match="xs:sequence" priority="1000" mode="M95">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@minOccurs) or xs:integer(@minOccurs) = 1">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Sequence has minimum and maximum cardinality 1</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:sequence" priority="1000" mode="M96">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:sequence"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@maxOccurs) or (@maxOccurs instance of xs:integer                                              and 1 = xs:integer(@maxOccurs))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@maxOccurs) or (@maxOccurs instance of xs:integer and 1 = xs:integer(@maxOccurs))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-18: An element xs:sequence MUST have minOccurs and maxOccurs of 1.</svrl:text>
   ...
   <!--PATTERN rule9-19xs:choice must be child of xs:sequence-->
   ...
   <xsl:template match="xs:choice" priority="1000" mode="M97">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(parent::xs:sequence)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:choice" priority="1000" mode="M98">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@minOccurs) or 1 = xs:integer(@minOccurs)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Choice has minimum and maximum cardinality 1</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:choice" priority="1000" mode="M99">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:choice"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@maxOccurs) or (@maxOccurs instance of xs:integer                                              and 1 = xs:integer(@maxOccurs))"/>
   ...
   <!--RULE -->
   <xsl:template match="node()[comment()]" priority="1000" mode="M100">
   ...
   <!--RULE -->
   <xsl:template match="xs:documentation/node()" priority="1000" mode="M101">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:documentation/node()"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="self::text() or self::comment()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="self::text() or self::comment()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M102">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name) and ends-with(@name, 'SimpleType')]" priority="1001" mode="M103">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name) and ends-with(@name, 'SimpleType')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="local-name() = 'simpleType'"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name) and ends-with(@name, 'Type')]" priority="1000" mode="M103">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name) and ends-with(@name, 'Type')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="local-name() = 'complexType'"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:simpleType[@name]" priority="1000" mode="M104">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ends-with(@name, 'SimpleType')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN rule9-28xs:sequence must be child of xs:extension-->
   ...
   <xsl:template match="xs:sequence" priority="1000" mode="M105">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(parent::xs:extension)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN rule9-29aType definition is top-level-->
   ...
   <xsl:template match="xs:simpleType" priority="1000" mode="M106">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(parent::xs:schema)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-29: A type definition MUST be top-level.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M106"/>
   ...
   <!--PATTERN rule9-29bType definition is top-level-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Type definition is top-level</svrl:text>
   <!--RULE -->
   ...
   <!--PATTERN Association type derived from structures:AssociationType-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Association type derived from structures:AssociationType</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M108">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <xsl:variable name="is-association-type" select="exists(@name[ends-with(., 'AssociationType')])"/>
      <xsl:variable name="has-association-base-type" select="         exists(xs:complexContent[           exists(xs:*[local-name() = ('extension', 'restriction')                       and exists(@base[ends-with(., 'AssociationType')])])])"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$is-association-type = $has-association-base-type">
               ...
               <svrl:text>Rule 9-32: A type definition that represents an association class MUST be derived from structures:AssociationType or from another association class.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M108"/>
   ...
   <!--PATTERN rule9-33Augmentation type derived from structures:AugmentationType-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Augmentation type derived from structures:AugmentationType</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[(self::xs:restriction or self::xs:extension)                            and ends-with(@base, 'AugmentationType')]" priority="1000" mode="M109">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[(self::xs:restriction or self::xs:extension)                            and ends-with(@base, 'AugmentationType')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor::xs:complexType[ends-with(@name, 'AugmentationType')]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::xs:complexType[ends-with(@name, 'AugmentationType')]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-33: A type definition that is an augmentation type MUST be derived from structures:AugmentationType.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M109"/>
   ...
   <!--PATTERN rule9-34Object type derived from structures:ObjectType-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Object type derived from structures:ObjectType</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType[exists(xs:complexContent)                                      and not(ends-with(@name, 'AssociationType')                                          or ends-with(@name, 'MetadataType')                                          or ends-with(@name, 'AugmentationType'))]" priority="1000" mode="M110">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[exists(xs:complexContent)                                      and not(ends-with(@name, 'AssociationType')                                          or ends-with(@name, 'MetadataType')                                          or ends-with(@name, 'AugmentationType'))]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $derivation-method in (xs:complexContent/xs:extension, xs:complexContent/xs:restriction), $base in $derivation-method/@base, $base-qname in resolve-QName($base, $derivation-method), $base-local-name in local-name-from-QName($base-qname) satisfies ( $base-qname = xs:QName('structures:ObjectType') or not(ends-with($base-local-name, 'AssociationType') or ends-with($base-local-name, 'MetadataType') or ends-with($base-local-name, 'AugmentationType')))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-34: A type with complex content that does not represent an adapter class, an association class, or an augmentation type MUST be derived from structures:ObjectType or from another object type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M110"/>
   ...
   <!--PATTERN rule9-35Complex type with simple content has structures:SimpleObjectAttributeGroup-->
   ...
   <!--RULE -->
   <xsl:template match="xs:simpleContent/xs:extension[        some $base-qname in resolve-QName(@base, .) satisfies          namespace-uri-from-QName($base-qname) = xs:anyURI('http://www.w3.org/2001/XMLSchema')          or ends-with(local-name-from-QName($base-qname), 'SimpleType')]" priority="1000" mode="M111">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:simpleContent/xs:extension[        some $base-qname in resolve-QName(@base, .) satisfies          namespace-uri-from-QName($base-qname) = xs:anyURI('http://www.w3.org/2001/XMLSchema')          or ends-with(local-name-from-QName($base-qname), 'SimpleType')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="xs:attributeGroup[                          resolve-QName(@ref, .) = xs:QName('structures:SimpleObjectAttributeGroup')]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:attributeGroup[ resolve-QName(@ref, .) = xs:QName('structures:SimpleObjectAttributeGroup')]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-35: A complex type definition with simple content MUST include structures:SimpleObjectAttributeGroup.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M111"/>
   ...
   <!--PATTERN rule9-36Base type definition defined by conformant schema-->
   ...
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M112">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $base-namespace in namespace-uri-from-QName(resolve-QName(@base, .)) satisfies ( $base-namespace = (nf:get-target-namespace(.), xs:anyURI('http://www.w3.org/2001/XMLSchema')) or exists(ancestor::xs:schema[1]/xs:import[exists(@namespace) and $base-namespace = xs:anyURI(@namespace) and empty(@appinfo:externalImportIndicator)]))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-36: The base type definition of a type definition MUST have the target namespace or the XML Schema namespace or a namespace that is imported as conformant.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M112"/>
   ...
   <!--PATTERN rule9-37aComponent reference defined by conformant schema-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Component reference defined by conformant schema</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(ancestor::xs:complexType[not(ends-with(@name, 'AdapterType'))]) and @ref]" priority="1000" mode="M113">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(ancestor::xs:complexType[not(ends-with(@name, 'AdapterType'))]) and @ref]"/>
      <xsl:variable name="namespace" select="namespace-uri-from-QName(resolve-QName(@ref, .))"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$namespace = nf:get-target-namespace(.) or exists(ancestor::xs:schema[1]/xs:import[exists(@namespace) and $namespace = xs:anyURI(@namespace) and empty(@appinfo:externalImportIndicator)])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-37: An attribute or element reference MUST have the target namespace or a namespace that is imported as conformant.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M113"/>
   ...
   <!--PATTERN rule9-37bComponent reference defined by conformant schema-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Component reference defined by conformant schema</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute[@ref]" priority="1000" mode="M114">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $namespace in namespace-uri-from-QName(resolve-QName(@ref, .)) satisfies ( $namespace = nf:get-target-namespace(.) or ancestor::xs:schema[1]/xs:import[ @namespace and $namespace = xs:anyURI(@namespace) and empty(@appinfo:externalImportIndicator)])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-37: An attribute or element reference MUST have the target namespace or a namespace that is imported as conformant.</svrl:text>
   ...
   <!--PATTERN rule9-38Schema uses only known attribute groups-->
   ...
   <xsl:template match="xs:attributeGroup[@ref]" priority="1000" mode="M115">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attributeGroup[@ref]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $ref in resolve-QName(@ref, .) satisfies ( $ref = xs:QName('structures:SimpleObjectAttributeGroup') or namespace-uri-from-QName($ref) = (xs:anyURI('urn:us:gov:ic:ism'), xs:anyURI('urn:us:gov:ic:ntk')))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-38: An attribute group reference MUST be structures:SimpleObjectAttributeGroup.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M115"/>
   ...
   <!--PATTERN rule9-39List item type defined by conformant schemas-->
   ...
   <xsl:template match="xs:list[exists(@itemType)]" priority="1000" mode="M116">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:list[exists(@itemType)]"/>
      <xsl:variable name="namespace" select="namespace-uri-from-QName(resolve-QName(@itemType, .))"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$namespace = (nf:get-target-namespace(.), xs:anyURI('http://www.w3.org/2001/XMLSchema')) or exists(ancestor::xs:schema[1]/xs:import[exists(@namespace) and $namespace = xs:anyURI(@namespace) and empty(@appinfo:externalImportIndicator)])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-39: The item type of a list simple type definition MUST have a target namespace equal to the target namespace of the XML Schema document within which it is defined, or a namespace that is imported as conformant by the schema document within which it is defined.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M116"/>
   ...
   <!--PATTERN rule9-40Union member types defined by conformant schemas-->
   ...
   <xsl:template match="xs:union[exists(@memberTypes)]" priority="1000" mode="M117">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:union[exists(@memberTypes)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN rule9-42aDeclarations are top-level-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(parent::xs:schema)">
               ...
               <svrl:text>Rule 9-42: An attribute declaration or element declaration MUST be top-level.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M118"/>
   ...
   <!--PATTERN rule9-42bDeclarations are top-level-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Declarations are top-level</svrl:text>
   <!--RULE -->
   ...
   <!--PATTERN rule9-43aElement type is not simple type-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Element type is not simple type</svrl:text>
   <!--RULE -->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $type-qname in resolve-QName(@type, .), $type-ns in namespace-uri-from-QName($type-qname), $type-local-name in local-name-from-QName($type-qname) satisfies ( $type-qname = xs:QName('xs:anySimpleType') or (($type-ns = nf:get-target-namespace(.) or exists(nf:get-document-element(.)/xs:import[ xs:anyURI(@namespace) = $type-ns and empty(@appinfo:externalImportIndicator)])) and not(ends-with($type-local-name, 'SimpleType'))))">
               ...
               <svrl:text>Rule 9-43: An element declaration MUST NOT have a simple type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M120"/>
   ...
   <!--PATTERN rule9-43bElement type is not simple type-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Element type is not simple type</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M121">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ends-with(@type, 'SimpleType'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-43: An element declaration MUST NOT have a simple type.</svrl:text>
   ...
   <!--PATTERN rule9-44aAttribute and element type is from conformant namespace-->
   ...
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M122">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="for $type-qname in resolve-QName(@type, .), $type-namespace in namespace-uri-from-QName($type-qname) return $type-namespace = nf:get-target-namespace(.) or exists(nf:get-document-element(.)/xs:import[ xs:anyURI(@namespace) = $type-namespace and empty(@appinfo:externalImportIndicator)])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-44: The type definition of an attribute or element declaration MUST have a target namespace that is the target namespace, or a namespace that is imported as conformant.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M122"/>
   ...
   <!--PATTERN rule9-44bAttribute and element type is from conformant namespace-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Attribute and element type is from conformant namespace</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M123">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[exists(@type)]"/>
      <xsl:variable name="namespace" select="namespace-uri-from-QName(resolve-QName(@type, .))"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="$namespace = (nf:get-target-namespace(.), xs:anyURI('http://www.w3.org/2001/XMLSchema'))                        or exists(ancestor::xs:schema[1]/xs:import[exists(@namespace)                                      and $namespace = xs:anyURI(@namespace)                                      and empty(@appinfo:externalImportIndicator)])"/>
         <xsl:otherwise>
   ...
   <!--PATTERN rule9-45Element substitution group defined by conformant schema-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Element substitution group defined by conformant schema</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@substitutionGroup)]" priority="1000" mode="M124">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@substitutionGroup)]"/>
      <xsl:variable name="namespace" select="namespace-uri-from-QName(resolve-QName(@substitutionGroup, .))"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="$namespace = nf:get-target-namespace(.)                        or exists(ancestor::xs:schema[1]/xs:import[exists(@namespace)                                      and $namespace = xs:anyURI(@namespace)                                      and empty(@appinfo:externalImportIndicator)])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$namespace = nf:get-target-namespace(.) or exists(ancestor::xs:schema[1]/xs:import[exists(@namespace) and $namespace = xs:anyURI(@namespace) and empty(@appinfo:externalImportIndicator)])">
               ...
               <svrl:text>Rule 9-45: An element substitution group MUST have either the target namespace or a namespace that is imported as conformant.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M124"/>
   ...
   <!--PATTERN rule9-47Only reference attributes have type xs:IDREFS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Only reference attributes have type xs:IDREFS</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M125">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(resolve-QName(@type, .) = xs:QName('xs:IDREFS')) = (@appinfo:referenceAttributeIndicator = 'true')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-47: The attribute declaration of a reference attribute MUST have type `xs:IDREFS`; all other components MUST NOT.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M125"/>
   ...
   <!--PATTERN rule9-49Import of external namespace has data definition-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Import of external namespace has data definition</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:import[@appinfo:externalImportIndicator]" priority="1000" mode="M126">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:import[@appinfo:externalImportIndicator]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $definition in xs:annotation/xs:documentation[1] satisfies                          string-length(normalize-space(string($definition))) &gt; 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $definition in xs:annotation/xs:documentation[1] satisfies string-length(normalize-space(string($definition))) &gt; 0">
               ...
               <svrl:text>Rule 9-49: An xs:import element importing an external schema document MUST be a documented component.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M126"/>
   ...
   <!--PATTERN rule9-50Structure of adapter type definition follows pattern-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Structure of adapter type definition follows pattern</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType[@appinfo:externalAdapterTypeIndicator]" priority="1000" mode="M127">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[@appinfo:externalAdapterTypeIndicator]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="xs:complexContent/xs:extension[                          resolve-QName(@base, .) = xs:QName('structures:ObjectType')                        ]/xs:sequence"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:complexContent/xs:extension[ resolve-QName(@base, .) = xs:QName('structures:ObjectType') ]/xs:sequence">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-50: An adapter type definition MUST be a complex type definition with complex content that extends structures:ObjectType, and that uses xs:sequence as its top-level compositor.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M127"/>
   ...
   <!--PATTERN rule9-51Element use from external adapter type defined by external schema documents-->
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@ref                                  and exists(ancestor::xs:complexType[exists(@appinfo:externalAdapterTypeIndicator)])]" priority="1000" mode="M128">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[@ref                                  and exists(ancestor::xs:complexType[exists(@appinfo:externalAdapterTypeIndicator)])]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $ref-namespace in namespace-uri-from-QName(resolve-QName(@ref, .)) satisfies nf:get-document-element(.)/xs:import[ $ref-namespace = xs:anyURI(@namespace) and @appinfo:externalImportIndicator]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-51: An element reference that appears within an adapter type MUST have a target namespace that is imported as external.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M128"/>
   ...
   <!--PATTERN rule9-52aExternal adapter type not a base type-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">External adapter type not a base type</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[(self::xs:extension or self::xs:restriction)       and (some $base-qname in resolve-QName(@base, .),       $base-namespace in namespace-uri-from-QName($base-qname) satisfies       nf:get-target-namespace(.) = $base-namespace)]" priority="1000" mode="M129">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[(self::xs:extension or self::xs:restriction)       and (some $base-qname in resolve-QName(@base, .),       $base-namespace in namespace-uri-from-QName($base-qname) satisfies       nf:get-target-namespace(.) = $base-namespace)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="nf:resolve-type(., resolve-QName(@base, .))[         empty(@appinfo:externalAdapterTypeIndicator)]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="nf:resolve-type(., resolve-QName(@base, .))[ empty(@appinfo:externalAdapterTypeIndicator)]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-52: An adapter type definition MUST NOT be a base type definition.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M129"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="nf:resolve-type(., resolve-QName(@base, .))[ empty(@appinfo:externalAdapterTypeIndicator)]">
               ...
               <svrl:text>Rule 9-52: An external adapter type definition MUST NOT be a base type definition.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M130"/>
   ...
   <!--PATTERN rule9-53External attribute use has data definition-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">External attribute use has data definition</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:attribute[some $ref-namespace in namespace-uri-from-QName(resolve-QName(@ref, .)),                                         $import in ancestor::xs:schema[1]/xs:import satisfies (                                      xs:anyURI($import/@namespace) = $ref-namespace                                      and exists(@appinfo:externalImportIndicator))]" priority="1000" mode="M131">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:attribute[some $ref-namespace in namespace-uri-from-QName(resolve-QName(@ref, .)),                                         $import in ancestor::xs:schema[1]/xs:import satisfies (                                      xs:anyURI($import/@namespace) = $ref-namespace                                      and exists(@appinfo:externalImportIndicator))]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $documentation in xs:annotation/xs:documentation[1] satisfies string-length(normalize-space(string($documentation))) &gt; 0">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-53: An external attribute use MUST be a documented component with a non-empty data definition.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M131"/>
   ...
   <!--PATTERN rule9-55External element use has data definition-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">External element use has data definition</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[        some $ref-namespace in namespace-uri-from-QName(resolve-QName(@ref, .)) satisfies          nf:get-document-element(.)/self::xs:schema//xs:import[            xs:anyURI(@namespace) = $ref-namespace            and @appinfo:externalImportIndicator]]" priority="1000" mode="M132">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[        some $ref-namespace in namespace-uri-from-QName(resolve-QName(@ref, .)) satisfies          nf:get-document-element(.)/self::xs:schema//xs:import[            xs:anyURI(@namespace) = $ref-namespace            and @appinfo:externalImportIndicator]]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $documentation in xs:annotation/xs:documentation[1] satisfies                          string-length(normalize-space(string($documentation))) &gt; 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $documentation in xs:annotation/xs:documentation[1] satisfies string-length(normalize-space(string($documentation))) &gt; 0">
               ...
               <svrl:text>Rule 9-55: An external attribute use MUST be a documented component with a non-empty data definition.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M132"/>
   ...
   <!--PATTERN rule9-57Proxy type has designated structure-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Proxy type has designated structure</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType[some $name in @name,       $extension in xs:simpleContent/xs:extension,       $base-qname in resolve-QName($extension/@base, $extension) satisfies       $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]" priority="1000" mode="M133">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[some $name in @name,       $extension in xs:simpleContent/xs:extension,       $base-qname in resolve-QName($extension/@base, $extension) satisfies       $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:simpleContent[ xs:extension[ empty(xs:attribute) and count(xs:attributeGroup) = 1 and xs:attributeGroup[ resolve-QName(@ref, .) = xs:QName('structures:SimpleObjectAttributeGroup')]]]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN rule9-58bName of augmentation types-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Name of augmentation types</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[ends-with(@name, 'AugmentationType')]" priority="1000" mode="M134">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[ends-with(@name, 'AugmentationType')]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="self::xs:complexType/xs:complexContent/xs:*[ (self::xs:extension or self::xs:restriction) and ends-with(@base, 'AugmentationType')]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-58: The XSD definition of an augmentation type MUST have a name ending in "AugmentationType"; all other XSD components MUST NOT.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M134"/>
   ...
   <!--PATTERN rule9-59Name of augmentation elements-->
   ...
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M135">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(@type[ends-with(., 'AugmentationType')]) = exists(@name[ends-with(., 'Augmentation')])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-59: The XSD declaration of an augmentation element MUST have a name ending in "Augmentation"; all other XSD components MUST NOT.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M135"/>
   ...
   <!--PATTERN rule9-61Standard opening phrase for augmentation point element data definition-->
   ...
   <!--RULE -->
   <xsl:template match="xs:element[ends-with(@name, 'AugmentationPoint')]/xs:annotation/xs:documentation[1]" priority="1000" mode="M136">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[ends-with(@name, 'AugmentationPoint')]/xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(starts-with(lower-case(normalize-space(.)), 'an augmentation point '))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(starts-with(lower-case(normalize-space(.)), 'an augmentation point '))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>Rule 9-61: The data definition for an augmentation point element SHOULD begin with standard opening phrase "An augmentation point...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M136"/>
   </xsl:template>
   ...
   <!--PATTERN rule9-62Standard opening phrase for augmentation element data definition-->
   ...
   <!--RULE -->
   <xsl:template match="xs:element[ends-with(@name, 'Augmentation')]/xs:annotation/xs:documentation[1]" priority="1000" mode="M137">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[ends-with(@name, 'Augmentation')]/xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="every $phrase                in ('supplements ', 'additional information about ')                satisfies not(starts-with(lower-case(normalize-space(.)), $phrase))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $phrase in ('supplements ', 'additional information about ') satisfies not(starts-with(lower-case(normalize-space(.)), $phrase))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>Rule 9-62: The data definition for an augmentation element SHOULD begin with the standard opening phrase "Supplements..." or "Additional information about...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M137"/>
   </xsl:template>
   ...
   <!--PATTERN rule9-63Standard opening phrase for augmentation type data definition-->
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[ends-with(@name, 'AugmentationType')]/xs:annotation/xs:documentation[1]" priority="1000" mode="M138">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType[ends-with(@name, 'AugmentationType')]/xs:annotation/xs:documentation[1]"/>
      <!--REPORT warning-->
      <xsl:if test="not(matches(lower-case(normalize-space(.)),                            '^a data type (that supplements|for additional information about)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(lower-case(normalize-space(.)), '^a data type (that supplements|for additional information about)'))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>Rule 9-63: The data definition for an augmentation type SHOULD begin with the standard opening phrase "A data type (that supplements|for additional information about)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M138"/>
   </xsl:template>
   ...
   <!--PATTERN rule9-66Augmentation point element corresponds to its base type-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Augmentation point element corresponds to its base type</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name[                                   matches(., 'AugmentationPoint$')])]" priority="1000" mode="M139">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@name[                                   matches(., 'AugmentationPoint$')])]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists( parent::xs:schema/xs:complexType[ @name = replace($element-name, 'AugmentationPoint$', 'Type') and exists(@name[not(ends-with(., 'AugmentationType'))]) and empty(@appinfo:externalAdapterTypeIndicator) and exists(child::xs:complexContent)])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-66: A schema document containing an element declaration for an augmentation point element MUST also contain a type definition for its augmented base type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M139"/>
   ...
   <!--PATTERN rule9-67An augmentation point element has no type-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">An augmentation point element has no type</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name[                                   matches(., 'AugmentationPoint$')])]" priority="1000" mode="M140">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@name[                                   matches(., 'AugmentationPoint$')])]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@type)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@type)">
               ...
               <svrl:text>Rule 9-67: An augmentation point element MUST have no type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M140"/>
   ...
   <!--PATTERN rule9-68An augmentation point element has no substitution group-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">An augmentation point element has no substitution group</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name[                                   matches(., 'AugmentationPoint$')])]" priority="1000" mode="M141">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[exists(@name[                                   matches(., 'AugmentationPoint$')])]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@substitutionGroup)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@substitutionGroup)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-68: An augmentation point element MUST have no substitution group.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M141"/>
   ...
   <!--PATTERN rule9-69Augmentation point element is only referenced by its base type-->
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType//xs:element[exists(@ref[       matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]" priority="1000" mode="M142">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType//xs:element[exists(@ref[       matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="QName(string(nf:get-target-namespace(ancestor::xs:complexType[1])), ancestor::xs:complexType[1]/@name) = QName(string(namespace-uri-from-QName(resolve-QName(@ref, .))), replace(local-name-from-QName(resolve-QName(@ref, .)), 'AugmentationPoint$', 'Type'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-69: An augmentation point element MUST only be referenced by its base type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M142"/>
   ...
   <!--PATTERN rule9-70aAugmentation point element use is optional and unbounded-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Augmentation point element use is optional and unbounded</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType//xs:element[exists(@ref[                             matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]" priority="1000" mode="M143">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType//xs:element[exists(@ref[                             matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(@minOccurs) and xs:integer(@minOccurs) = 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(@minOccurs) and xs:integer(@minOccurs) = 0">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-70: An augmentation point element particle MUST have attribute minOccurs equal to 0 and attribute maxOccurs set to unbounded.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M143"/>
   ...
   <!--PATTERN rule9-70bAugmentation point element use is optional and unbounded-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Augmentation point element use is optional and unbounded</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType//xs:element[exists(@ref[                             matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]" priority="1000" mode="M144">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType//xs:element[exists(@ref[                             matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(@maxOccurs) and string(@maxOccurs) = 'unbounded'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(@maxOccurs) and string(@maxOccurs) = 'unbounded'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-70: An augmentation point element particle MUST have attribute minOccurs equal to 0 and attribute maxOccurs set to unbounded.</svrl:text>
   ...
   <!--PATTERN rule9-71Augmentation point element use must be last element in its base type-->
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType//xs:element[exists(@ref[                             matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]" priority="1000" mode="M145">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType//xs:element[exists(@ref[                             matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(following-sibling::*)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(following-sibling::*)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-71: An augmentation point element particle MUST be the last element occurrence in the content model of its augmentable type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M145"/>
   ...
   <!--PATTERN rule9-80Appinfo attribute annotates schema component-->
   ...
   <xsl:template match="*[exists(@appinfo:deprecated)]" priority="1000" mode="M146">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[exists(@appinfo:deprecated)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="namespace-uri-from-QName(node-name(.)) = xs:anyURI('http://www.w3.org/2001/XMLSchema')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="namespace-uri-from-QName(node-name(.)) = xs:anyURI('http://www.w3.org/2001/XMLSchema')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-80: An attribute in the appinfo namespace MUST be owned by an element with a namespace name http://www.w3.org/2001/XMLSchema .</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M146"/>
   ...
   <!--PATTERN rule9-81xs:appinfo children are comments, elements, or whitespace-->
   ...
   <xsl:template match="xs:appinfo/node()" priority="1000" mode="M147">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="self::comment() or self::element() or self::text()[string-length(normalize-space(.)) = 0]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-81: A child of element xs:appinfo MUST be an element, a comment, or whitespace text.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M147"/>
   ...
   <!--PATTERN rule9-82Appinfo child elements have namespaces-->
   ...
   <xsl:template match="xs:appinfo/*" priority="1000" mode="M148">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="namespace-uri() != xs:anyURI('')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-82: An element that is a child of xs:appinfo MUST have a namespace name.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M148"/>
   ...
   <!--PATTERN rule9-83Appinfo descendants are not XML Schema elements-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               ...
               <svrl:text>Rule 9-83: An element that is a descendent of xs:appinfo MUST NOT have the XML Schema namespace.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M149"/>
   ...
   <!--PATTERN rule9-85LocalTerm appinfo applies to schema-->
   ...
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M150">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="parent::xs:appinfo[parent::xs:annotation[parent::xs:schema]]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-85: When the element appinfo:LocalTerm appears in a schema document, it MUST be application information on an element xs:schema.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M150"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:schema[exists(@targetNamespace)                                 and (some $element                                     in nf:resolve-namespace(., xs:anyURI(@targetNamespace))                                     satisfies $element is .)]" priority="1000" mode="M151">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema[exists(@targetNamespace)                                 and (some $element                                     in nf:resolve-namespace(., xs:anyURI(@targetNamespace))                                     satisfies $element is .)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="count(nf:resolve-namespace(., xs:anyURI(@targetNamespace))) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(nf:resolve-namespace(., xs:anyURI(@targetNamespace))) = 1">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M152">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:import"/>
      <xsl:variable name="namespace" select="@namespace"/>
      <xsl:variable name="is-conformant" select="empty(@appinfo:externalImportIndicator)"/>
      <xsl:variable name="first" select="exactly-one(parent::xs:schema/xs:import[@namespace = $namespace][1])"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test=". is $first                        or $is-conformant = empty($first/@appinfo:externalImportIndicator)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". is $first or $is-conformant = empty($first/@appinfo:externalImportIndicator)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN rule8-9Reference namespace asserts conformance-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Reference namespace asserts conformance</svrl:text>
   <!--RULE -->
   <xsl:template match="*[. is nf:get-document-element(.)]" priority="1000" mode="M153">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[. is nf:get-document-element(.)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 8-9: A reference namespace must assert the conformance target identifier https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M153"/>
   ...
   <!--PATTERN rule8-10Reference namespace does not have wildcard-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Reference namespace does not have wildcard</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:any" priority="1001" mode="M154">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               ...
               <svrl:text>Rule 8-10: The schema MUST NOT contain the element xs:any.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M154"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:anyAttribute" priority="1000" mode="M154">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               ...
               <svrl:text>Rule 8-10: The schema MUST NOT contain the element xs:anyAttribute.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M154"/>
   ...
   <!--PATTERN rule8-12Reference namespace uses reference namespace components-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Reference namespace uses reference namespace components</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:import[                           nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))                           and exists(@namespace)                           and empty(@appinfo:externalImportIndicator)                           and not(xs:anyURI(@namespace) = (xs:anyURI('https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/'),                                                            xs:anyURI('http://www.w3.org/XML/1998/namespace')))]" priority="1000" mode="M155">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:import[                           nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))                           and exists(@namespace)                           and empty(@appinfo:externalImportIndicator)                           and not(xs:anyURI(@namespace) = (xs:anyURI('https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/'),                                                            xs:anyURI('http://www.w3.org/XML/1998/namespace')))]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="some $schema in nf:resolve-namespace(., @namespace) satisfies                          nf:has-effective-conformance-target-identifier($schema, xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="some $schema in nf:resolve-namespace(., @namespace) satisfies nf:has-effective-conformance-target-identifier($schema, xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 8-12: A component that is used in a reference namespace MUST be defined in a reference namespace.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M155"/>
   ...
   <!--PATTERN rule9-86No simple type disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No simple type disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:simpleType" priority="1000" mode="M156">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:simpleType"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@final)">
               ...
               <svrl:text>Rule 9-86: A reference schema document MUST NOT have an attribute {}final.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M156"/>
   ...
   <!--PATTERN rule9-87No use of fixed on simple type facets-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No use of fixed on simple type facets</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:*[self::xs:length or self::xs:minLength or self::xs:maxLength or self::xs:whiteSpace       or self::xs:maxInclusive or self::xs:maxExclusive or self::xs:minExclusive or self::xs:minInclusive       or self::xs:totalDigits or self::xs:fractionDigits]" priority="1000" mode="M157">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[self::xs:length or self::xs:minLength or self::xs:maxLength or self::xs:whiteSpace       or self::xs:maxInclusive or self::xs:maxExclusive or self::xs:minExclusive or self::xs:minInclusive       or self::xs:totalDigits or self::xs:fractionDigits]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@fixed)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@fixed)">
               ...
               <svrl:text>Rule 9-87: A simple type constraining facet in a reference schema document MUST NOT have an attribute {}fixed.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M157"/>
   ...
   <!--PATTERN rule9-88aNo disallowed substitutions-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed substitutions</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M158">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@block)">
               ...
               <svrl:text>Rule 9-88: A reference schema document MUST NOT contain the attribute {}block or {}blockDefault.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M158"/>
   ...
   <!--PATTERN rule9-88bNo disallowed substitutions-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed substitutions</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element" priority="1000" mode="M159">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@block)"/>
   ...
   <!--PATTERN rule9-88cNo disallowed substitutions-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed substitutions</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M160">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN rule9-89aNo disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M161">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@final)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@final)">
               ...
               <svrl:text>Rule 9-89: A reference schema document MUST NOT contain the attribute {}final or {}finalDefault.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M161"/>
   ...
   <!--PATTERN rule9-89bNo disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element" priority="1000" mode="M162">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@final)"/>
   ...
   <!--PATTERN rule9-89cNo disallowed derivation-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No disallowed derivation</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M163">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN rule9-90Element declaration is nillable-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Element declaration is nillable</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:element[@name and (empty(@abstract)                                             or xs:boolean(@abstract) = false())]" priority="1000" mode="M164">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:element[@name and (empty(@abstract)                                             or xs:boolean(@abstract) = false())]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(@nillable)                        and xs:boolean(@nillable) = true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(@nillable) and xs:boolean(@nillable) = true()">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 9-90: An element declaration in a reference schema document MUST have the {nillable} property with a value of true.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M164"/>
   ...
   <!--PATTERN rule9-91No xs:choice-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">No xs:choice</svrl:text>
   <!--RULE -->
   <xsl:template match="xs:choice" priority="1000" mode="M165">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:choice"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="false()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               ...
               <svrl:text>Rule 9-91: A reference schema document MUST NOT contain the element xs:choice.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M165"/>
