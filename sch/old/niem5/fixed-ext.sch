...
<sch:pattern id="rule_10-49"><sch:title>Attribute name begins with lower case letter</sch:title>
  <sch:rule context="xs:attribute[exists(@name)]">
    <sch:assert test="matches(@name, '^[a-z]')">Rule 10-49: Within the schema, any attribute declaration MUST have a name that begins with a lowercase letter ('a'-'z').</sch:assert>
  </sch:rule>
</sch:pattern>
